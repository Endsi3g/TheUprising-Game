...
import { TrackHomeVisit } from '@/components/analytics/TrackHomeVisit';
import { FRAMER_HOME_HERO_URL } from '@/lib/config';
...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col overflow-hidden bg-background-light dark:bg-background-dark text-gray-900 dark:text-gray-100 font-sans selection:bg-gray-200 dark:selection:bg-gray-700 transition-colors duration-300">
      ...
      {/* Main Content */}
      <main className="flex-grow flex flex-col items-center justify-center relative px-4 sm:px-8 py-10">
        ...
        <div className="max-w-5xl w-full flex flex-col items-center space-y-12 z-10">

          <HomeHero framerUrl={FRAMER_HOME_HERO_URL} />
